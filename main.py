...
SUDO_USERS = [6764661699, 6705556585]
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳", url=f"https://t.me/staystrongbros") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔", url="https://t.me/staytrongbros") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋", url="https://t.me/staystrongbrod")                              
                ],           
            ]
      )
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/bhanu` - Download and upload files (sudo)🎬\n\n"
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[warrior](https://t.me/staystrongbros)"
    if raw_text3 == '1':
        CR = '[warrior](https://t.me/staystrongbros)'
    elif raw_text3:
        try:
